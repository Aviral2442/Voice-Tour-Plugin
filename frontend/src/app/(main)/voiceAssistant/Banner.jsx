  ...
  return (
    <div className={classes.wrapper} data-aos="fade-up">
      <div className={classes.body} >
        <Title className={clsx(classes.title,font.className)}><span style={{ color: '#ADFF2F' }}>Experience</span>  Voice Command  <br /><span style={{ color: '#ADFF2F' }}>And</span> <br />   <span style={{ color: '#ADFF2F' }}>Free</span> Navigation  </Title>
