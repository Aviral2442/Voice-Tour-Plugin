            ...
            <div className={classes.inner}>
                ...
                <div className={classes.controls}>
                    ...
                    >
                        ...
                        &nbsp;
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="32" height="32" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ADFF2F" fill="none" stroke-linecap="round" stroke-linejoin="round">
