...
import { ThemeIcon, Progress, Text, Group, Badge, Paper, rem, Container, SimpleGrid, Image, ActionIcon, Grid, Flex, Card, Button } from '@mantine/core';
                ...
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>Sarah  M</Text>
            ...
            <Carousel.Slide>
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>John  D</Text>
                            <Text size="sm" className={classes.review}>
            ...
            <Carousel.Slide>
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>Emily L</Text>
                            <Text size="sm" className={classes.review}>
            ...
            <Carousel.Slide>
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>Michael P</Text>
                            <Text size="sm" className={classes.review}>
            ...
            <Carousel.Slide>
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>Alex V</Text>
                            <Text size="sm" className={classes.review}>
            ...
            <Carousel.Slide>
                <Container className={classes.Container}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className={classes.cardsquare}>
                        ...
                        <Group className={classes.midcontent} >
                            <Text fw={700} className={classes.name}>Lisa S</Text>
                            <Text size="sm" className={classes.review}>
