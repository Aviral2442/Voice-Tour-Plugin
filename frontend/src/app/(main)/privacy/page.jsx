        ...
        <Navbar />
            ...
            <Container size="xl" bg={"black"} p="xl">
                <Paper shadow="xs" radius="md"  p={15 } bg={"black"}>
                    ...
                    <br />
                    <Title order={4} mt="md">Information Collection</Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">Use of Information </Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">Data Sharing</Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">Data Security</Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">User Rights</Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">Cookies and Tracking</Title>
                    ...
                    <br />
                    <Title order={4}  mt="md">Changes to Policy</Title>
