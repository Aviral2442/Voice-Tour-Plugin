    ...
    <>
      ...
      <Container size="xl" bg={"black"} p="xl">
        <Paper shadow="xs" radius="md" p={15} bg={"black"}>
          ...
          <Title order={4} mt="md">Acceptance of Terms</Title>
          ...
          <br />
          <Title order={4} mt="md">User Conduct</Title>
          <Text className={clsx(classes.text, font.className)}> Define acceptable and prohibited uses of the website, including actions such as unauthorized access, spamming, and illegal activities.
          </Text>
          <br />

          <Title order={4} mt="md">Intellectual Property</Title>
          ...
          <Title order={4} mt="md">Indemnification</Title>
          ...
          <Title order={4} mt="md">Governing Law</Title>
          ...
          <Title order={4} mt="md">Changes to Terms</Title>
