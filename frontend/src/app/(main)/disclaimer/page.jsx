    ...
    <>
      ...
      <Container size="xl" bg={"black"} p="xl">
        <Paper shadow="xs" radius="md" p={15} bg={"black"}>
          <Title className={clsx(classes.title, fonts.className)} fz={50}>Disclaimer </Title>
          ...
          <Title order={4}>Accuracy of Information:</Title>
          ...
          <Title order={4}>No Guarantees:</Title>
          ...
          <Title order={4}>Third-Party Content:</Title>
          ...
          <Title order={4}>Professional Advice:</Title>
          ...
          <Title order={4}>Changes to Content:</Title>
          ...
          <Title order={4}>No Endorsement:</Title>
          ...
          <Title order={4}>User Responsibility: </Title>
