...
import { ThemeIcon, Progress, Text, Group, Badge, Paper, rem, Container, SimpleGrid, Image, ActionIcon, Grid, Title } from '@mantine/core';
                        ...
                        <Paper radius="md" withBorder className={classes.cardsquare} >
                            ...
                            <Grid grow gutter="xl" >
                                ...
                                <Grid.Col span={7}>
                                    ...
                                    <Text c="#C0C0C0" fz="sm" className={fonts.className}>
                                        @sophia_w
                                    </Text>
